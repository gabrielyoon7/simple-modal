...
function Modal(_a) {
    ...
    return (_jsxs(_Fragment, { children: [modalOpen && (_jsxs(ModalContainer, { children: [_jsx(ModalBackDrop, { onClick: closeModal }), _jsx(ModalContent, { children: children })] })), _jsx("div", {})] }));
}
